...
TOOLS: Read your batch file with the Read tool. Use WebSearch and WebFetch (load with ToolSearch "select:WebFetch,WebSearch" if deferred). NEVER use browser tools, never log in, never join. Budget: roughly 2-4 web lookups per entry; the description, candidate notes and sources in the batch already tell you a lot. Well-known projects/creators/conferences need one lookup of the official site.
